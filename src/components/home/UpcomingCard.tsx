...
export function UpcomingCard({ item }: { item: UpcomingItemData }) {
  return (
    <article className="flex h-full flex-col overflow-hidden rounded-[10px] border border-border bg-surface transition-all duration-200 hover:-translate-y-0.5 hover:border-primary hover:shadow-card-hover">
      <div className="relative h-40 shrink-0 border-b border-border bg-white">
      ...
      <div className="flex flex-1 flex-col p-[11px]">
