...
/**
 * No <Container> here on purpose — this renders inside HeroSearchSection's
 * already-padded main column (itself inside a page Container), so wrapping
 * it in a second Container would double the horizontal padding and shrink
 * it below the column's real available width.
 */
